...
import com.test.util.CustomErrorType;
...
public class RestApiController {
    ...
    public ResponseEntity<String> saveUsersList(@RequestBody List<User> users, UriComponentsBuilder ucBuilder) {
    ...
    public ResponseEntity<?> evictCache() {
        ...
        return new ResponseEntity<String>("Evicted", HttpStatus.OK);
    }
